...
class Camera {
    ...
    public pos : RaeptorTypes.SmartVector3;
    public rot : RaeptorTypes.SmartVector3;
	
	constructor(x : number, y : number, z : number, rotx : number, roty : number, rotz : number) {
		
		this.pos = new RaeptorTypes.SmartVector3(x,y,z);
		this.rot = new RaeptorTypes.SmartVector3(rotx,roty,rotz);
...
class Point {
    ...
    public pos : RaeptorTypes.SmartVector3;
    public vel : RaeptorTypes.SmartVector3;
	...
	constructor(x : number, y : number, z : number) {
		...
		this.pos = new RaeptorTypes.SmartVector3(x,y,z);
		this.vel = new RaeptorTypes.SmartVector3(0,0,0);
		this.links = [];
		this.hasMove = false;
	...
	get2DProjection(camera : Camera, plane : Plane) : RaeptorTypes.SmartVector3 | null {
		...
		return new RaeptorTypes.SmartVector3(
...
class Segment {
	...
	get2DProjection(camera : Camera, plane : Plane) : Array<RaeptorTypes.SmartVector3> | null {
		
        const PointA : RaeptorTypes.SmartVector3 | null = this.points[0].get2DProjection(camera,plane);
        const PointB : RaeptorTypes.SmartVector3 | null = this.points[1].get2DProjection(camera,plane);
...
class Mesh {
    ...
    public pos : RaeptorTypes.SmartVector3;
    public rot : RaeptorTypes.SmartVector3;
    public scale : RaeptorTypes.SmartVector3;
	...
	constructor() {
        ...
        this.points = [];
        this.faces = [];
        this.pos = new RaeptorTypes.SmartVector3(0,0,0);
        this.rot = new RaeptorTypes.SmartVector3(0,0,0);
        this.scale = new RaeptorTypes.SmartVector3(1,1,1);
		this.createPoints();
		this.createFaces();
		this.cameraDistance = 0;
