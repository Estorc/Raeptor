...
export class RaeptorWebGLObjectsBase3D extends RaeptorWebGLObjectsBase {
    private position : vec3 = [0, 0, 0];
    private rotation : mat4 = mat4.create();
    private scale : vec3 = [1, 1, 1];

    constructor(gl : WebGLRenderingContext, vsSourceURL : string = '/assets/shaders/raeptor.shader.fancy-wireframe.vs', fsSourceURL : string = '/assets/shaders/raeptor.shader.fancy-wireframe.fs') {
