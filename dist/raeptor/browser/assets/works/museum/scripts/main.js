...
{image:"images/RadioNAG.png",link:"https://radio-nag.guillarda.fr",text:"“RADIO N.A.G.”\n~ 2021 - Estorc ~\n%SIZE30%end\“Une radio que j'ai assisté dans sa création, notamment en créant le site internet et en codant un programme d'aquisition de flux audio.”\n\nAppuyez sur Espace pour explorer.",posx:297,posy:3.25,posz:-18,rot:-Math.PI/2,type:1},
...
{image:"images/museum.png",link:".",text:"“Ræptor Museum”\n~ 2022 - Estorc ~\n%SIZE30%end\“Un musée où est exposé tout les projets importants de Estorc.”\n%SIZE16%end\n%SIZE30%end\(Instructions : Flèches directionnelles. (Ou avec ZQSD) pour se déplacer, Espace pour valider)\n\nAppuyez sur Espace pour explorer.",posx:119,posy:3.25,posz:162,rot:Math.PI,type:1},
...
{image:"images/OG2.png",link:null,text:"“Oujnish Game 2”\n~ 2021 - Estorc ~\n%SIZE30%end\“Un grand jeu Open World mêlant RPG à tour par tour et Bullet Hell. Plein d'humour et de parodie autour de l'univers Geek, Oujnish Game 2 est un jeu avec une très longue durée de vie (~70 heures pour le 100%), comparable au couteau suisse de mes projets tant il vient piocher dans chacune de mes compétences.”\n%SIZE16%end\n%SIZE30%end\(Avertissement : En raison des lois très flous autour de la parodie, le jeu est actuellement uniquement fourni en main propre pour éviter une trop grande propagation. S'il se trouve que je suis en droit de partager ce jeu, je le ferai, et il sera disponible en Freeware.)\n\nJeu indisponible pour le moment.",posx:-65,posy:3.25,posz:167.5,rot:Math.PI,type:1},
...
{image:"images/TDS.png",link:"/works/OldProjects/The%20Dark%20Storm",text:"“The Dark Storm”\n~ 2018 - Estorc ~\n%SIZE30%end\“Un vieux jeu inachevé. Il s'inspire des jeux RPG/Hack 'n' Slash et propose un vaste monde de Dark Fantasy à explorer.”\n%SIZE16%end\n%SIZE30%end\(Instructions : ZQSD pour se déplacer, Clique gauche pour tirer, Espace pour valider)\n\nAppuyez sur Espace pour explorer.",posx:-81.5,posy:3.25,posz:-102,rot:0,type:1},
...
function loopEnd() { // Executed at the end of each frames
	...
	if (warp) {
		if (museumTex.materials['FLOOR'].opacity > 0) {
			...
			window.parent.postMessage({ action: 'changeUrl', url: `${link}/?origin=museum` }, '*');
			loopBreak = true;
		}
	}
